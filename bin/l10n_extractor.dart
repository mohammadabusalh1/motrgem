...
Future<void> _handleStartCommand(List<String> args) async {
  ...
  try {
    ...
    if (result.success) {
      ...
      print('  2. Run: dart run bin/l10n_extractor.dart --dry-run');
      print('  3. Run: dart run bin/l10n_extractor.dart --replace');
      exit(0);
    } else {
...
void _printStartUsage() {
  print('Flutter L10n Text Extractor - Start Command');
  print('');
  print('Initializes a Flutter project with l10n support.');
  print('');
  print('Usage: dart run bin/l10n_extractor.dart start [options]');
  print('');
  print('Options:');
  ...
  print('');
  print('Example:');
  print('  dart run bin/l10n_extractor.dart start');
}
...
void _printUsage(ArgParser parser) {
  ...
  print('');
  print('Usage: dart run bin/l10n_extractor.dart [command] [options]');
  print('');
  print('Commands:');
  ...
  print('  dart run bin/l10n_extractor.dart --dry-run');
  print('');
  print('  # Extract texts and add to ARB file (no code changes)');
  print('  dart run bin/l10n_extractor.dart');
  print('');
  print('  # Extract texts and replace in code');
  print('  dart run bin/l10n_extractor.dart --replace');
  print('');
  print('  # Add a new locale (Spanish)');
  print('  dart run bin/l10n_extractor.dart --add-locale es');
  print('');
  print('  # Process a specific project');
  print(
    '  dart run bin/l10n_extractor.dart --project /path/to/project --replace',
  );
}
